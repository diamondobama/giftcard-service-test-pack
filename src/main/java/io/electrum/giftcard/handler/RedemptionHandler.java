...
public class RedemptionHandler {
   ...
   public Response handle(UUID requestId, RedemptionRequest request, HttpHeaders httpHeaders, UriInfo uriInfo) {
      ...
      try {
         ...
         redemptionRecord = new RedemptionRecord(requestId.toString());
