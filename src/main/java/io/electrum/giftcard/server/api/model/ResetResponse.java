...
public class ResetResponse {
   ...
   public enum Outcomes {
      ...
      UNKNOWN_USER("The Test Server was unable to locate the user specific database to reset. Please confirm HTTP Basic Auth credentials used or continue testing with different credentials.");
