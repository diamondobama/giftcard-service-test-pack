package io.electrum.giftcard.server;
...
public class GiftcardTestServerRunner {
   ...
   public static void main(String[] args) throws Exception {
      startGiftcardTestServer(args[0]);
   }

   public static void startGiftcardTestServer(String port) throws Exception {

      log_logger.info("---- STARTING GIFTCARD SERVER ----");
      ...
      try {
         ...
         http_config.setSecurePort(8443);//new Integer(port));
         ...
         testServer = new GiftcardTestServer();
